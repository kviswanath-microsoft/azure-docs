...
Azure Active Directory (Azure AD) authorizes access rights to secured resources through Azure RBAC. Azure Storage defines a set of  built-in RBAC roles that encompass common sets of permissions used to access file data. You can also define custom roles for access to file data. To learn more about assigning Azure roles for file access, see [Assign an Azure role for access to file data](../blobs/assign-azure-role-data-access.md).
